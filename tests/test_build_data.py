...
def test_apply_htmx_v2_adjustments_removes_old_extensions_and_adds_hx_on() -> None:
    ...
    payload = {
        "globalAttributes": [
            {"name": "hx-get", "references": [{"name": "Official documentation", "url": "https://htmx.org/attributes/hx-get/"}]},
            {"name": "hx-sse", "references": [{"name": "Official documentation", "url": "https://htmx.org/attributes/hx-sse/"}]},
            {"name": "hx-ws", "references": [{"name": "Official documentation", "url": "https://htmx.org/attributes/hx-ws/"}]},
        ]
    }
